                        ...
                        <!-- Nested Row within Card Body -->
                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Please enter Employee Information</h1>
                                    </div>
                                    <form class="user" action = "employee_insertion.php" method = "post">
                                        ...
                                        <div class="form-group">
                                            <input type="depart_from" class="form-control form-control-user" name = "phone"
